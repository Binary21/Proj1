 ...
 */
// checks if the UART reciever buffer has a character to prevent holds in the code
...
// gets Char from the UART reciever buffer
...
//       In the implementation file, prefer explaining HOW the function is
//       implemented over simply WHAT the function does.
// Checks if the transmitter buffer is empty
...
//       In the implementation file, prefer explaining HOW the function is
//       implemented over simply WHAT the function does.
// moves the chacter C to the UART transmitter buffer
